...
class ConnectionFinderService {
  ...
  Set<String> _removeStopWords(Set<String> words) {
    const stopWords = {
      ...
      'too',
      'use',
      // NOTE: Do not add words that appear in theme keyword lists
      // (e.g. 'mom', 'dad', 'work', 'make', 'home', 'food', 'art')
      // as they are needed for theme detection and connection finding.
      'about',
      'been',
      'call',
      'come',
